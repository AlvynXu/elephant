...
public class WheelView extends View {
    ...
    private List<ProvincesModel.DataBean> data;
    ...
    private static final float maxScaleTextSizeToItemHeight = 0.4f;
    private static final float minScaleTextSizeToItemHeight = 0.3f;
    ...
    public interface IWheelViewSelectedListener {
        void wheelViewSelectedChanged(WheelView myWheelView, List<ProvincesModel.DataBean> data, int position);
    ...
    private void initAttributesData(TypedArray typedArray) {
        ...
        selectedLinePaint.setColor(typedArray.getColor(R.styleable.MyWheelView_selected_line_color, Color.rgb(153, 153, 153)));
...
//        normalTextPaint.setColor(typedArray.getColor(R.styleable.MyWheelView_normal_text_color, Color.rgb(154, 154, 154)));
        selectedTextPaint.setColor(typedArray.getColor(R.styleable.MyWheelView_selected_text_color, Color.rgb(48, 48, 48)));
        normalTextPaint.setColor(typedArray.getColor(R.styleable.MyWheelView_normal_text_color, Color.rgb(204, 204, 204)));
        //     selectedTextPaint.setColor(typedArray.getColor(R.styleable.MyWheelView_selected_text_color, Color.rgb(153, 153, 153)));
     ...
     */
    public void setDataWithSelectedItemIndex(List<ProvincesModel.DataBean> data, int selectedItemIndex, String type) {
    ...
    private static class MyWheelViewHandler extends Handler {
        ...
        private WeakReference<WheelView> myWheelViewWeakReference;

        private MyWheelViewHandler(WheelView myWheelView) {
