...
//    = R.drawable.background_tab;//字体颜色的选择器
    ...
    public CustomIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(R.styleable.TPIndicator_indicatorColor, tabTextColor);

        a.recycle();

        // get custom attrs

        a = context.obtainStyledAttributes(attrs, R.styleable.TPIndicator);

        indicatorColor = a.getColor(R.styleable.TPIndicator_indicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.TPIndicator_underlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.TPIndicator_dividerColor, dividerColor);
        indicatorHeight = a.getDimensionPixelSize(R.styleable.TPIndicator_indicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(R.styleable.TPIndicator_underlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.TPIndicator_pst_dividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.TPIndicator_tabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.TPIndicator_tabBackgrounds, tabBackgroundResId);
//        isSameLine = a.getBoolean(R.styleable.PagerSlidingTab_sameLine, isSameLine);
        scrollOffset = a.getDimensionPixelSize(R.styleable.TPIndicator_scrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.TPIndicator_pst_textAllCaps, textAllCaps);
